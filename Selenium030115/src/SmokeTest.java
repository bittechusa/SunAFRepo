...
public class SmokeTest extends BaseTest 
{
	...
	public void test1()
	{
		...
		dr.findElement(By.id("email")).sendKeys("bvdj");//to type anything
		dr.findElement(By.id("pass")).click();//to click anything
		WebElement ele=dr.findElement(By.id("pass"));
		dr.findElements(By.xpath(""));//to get element size
